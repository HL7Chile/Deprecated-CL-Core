// Originally defined on lines 1 - 152
Profile: PrestadorCL
Parent: Practitioner
Id: CorePrestadorCl
Title: "PrestadorCl"
...
* name.family 1..1
* name.family.extension contains http://hl7.org/fhir/StructureDefinition/humanname-mothers-family named mothers-family 0..
* name.family.extension[mothers-family] 0..1
...
* qualification[Cert] MS
* qualification[Esp] 0..*
* qualification[Esp] MS
