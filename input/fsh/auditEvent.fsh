...
* type.system ^short = "Value set de los códigos para tipo de Evento"
* type.system ^definition = "Es el valueset sugerido por FHIR extensible a necesidades locales"
...
* subtype.system 1.. MS
* subtype.system from http://hl7.org/fhir/ValueSet/audit-event-sub-type (example)
