...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient">
      <sch:assert test="count(f:extension[@url = 'http://core.hl7chile.cl/StructureDefinition/CodigoPaises']) &lt;= 1">extension with URL = 'http://core.hl7chile.cl/StructureDefinition/CodigoPaises': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Patient/f:identifier/f:type">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://core.hl7chile.cl/StructureDefinition/CodigoPaises']) &gt;= 1">extension with URL = 'http://core.hl7chile.cl/StructureDefinition/CodigoPaises': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'http://core.hl7chile.cl/StructureDefinition/CodigoPaises']) &lt;= 1">extension with URL = 'http://core.hl7chile.cl/StructureDefinition/CodigoPaises': maximum cardinality of 'extension' is 1</sch:assert>
